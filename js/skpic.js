...
$(window).resize(function () {
    if ($(window).width() >= 768) {
        ...
        menuVisible = false; //메뉴를 보이지 않게 함
        // menuVisible은 변수이며, 이 변수는 Boolean 값을 저장하는데 사용
        // Boolean은, false나 true 두가지만 가질 수 있는 데이터 유형임
        // 여기에서 menuVisible 변수를 false로 설정하여 메뉴 보이지 않음, 숨김 상태를 만들었음.
        // Boolean 이라는 것은, 참이나 거짓 상태를 나타내는
    }
});
